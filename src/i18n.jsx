...
export const STRINGS = {
  es: {
    ...
    products: {
      // Wagyu Japonés A5
      tritip:   { name: 'Tri-Tip Wagyu Japonés A5', badge: 'A5 · Japón', desc: 'Wagyu japonés auténtico grado A5 — la cima del marmoleo. Mantecoso, intenso, se deshace al contacto.' },
      filete:   { name: 'Filete Wagyu Japonés A5', desc: 'Filete (lomo fino) de wagyu japonés A5. El corte más tierno, con marmoleo delicado y textura mantecosa.' },
      ribeyeJp: { name: 'Rib Eye Wagyu Japonés A5', desc: 'Rib eye de wagyu japonés A5 — marmoleo extremo y sabor profundo. La experiencia wagyu en su máxima expresión.' },
      picana:   { name: 'Picaña Wagyu Japonés A5', desc: 'Picaña de wagyu japonés A5 con su capa de grasa característica. Jugosa y llena de sabor, ideal a la parrilla.' },
      // Wagyu Australiano
      ribeye:   { name: 'Rib Eye Wagyu Australiano', badge: 'Alto Marmoleo', desc: 'Rib eye de wagyu australiano, marmoleo intenso en todo el ojo. El corte estrella de tu menú.' },
      newyork:  { name: 'New York Wagyu Australiano', badge: 'Más Vendido', desc: 'Mordida firme, sabor profundo a res y marmoleo generoso. El clásico de steakhouse.' },
      tbone:    { name: 'T-Bone Wagyu Australiano', desc: 'T-Bone de wagyu australiano — lomo y filete en un solo corte, con hueso para máximo sabor.' },
      paleta:   { name: 'Paleta Wagyu Australiano', desc: 'Paleta de wagyu australiano, marmoleada y versátil. Para estofar, asar o cortar en finas láminas.' },
      denver:   { name: 'Denver Wagyu Australiano', desc: 'Denver de wagyu australiano — corte jugoso de alto marmoleo, tierno y con gran sabor. Excelente a la parrilla.' },
      topround: { name: 'Top Round Wagyu Australiano', desc: 'Top Round de wagyu australiano, marmoleo poco común en este corte. Ideal en finas láminas o sukiyaki.' },
      lengua:   { name: 'Lengua Wagyu Australiano', desc: 'Lengua de wagyu australiano de alto marmoleo. Una especialidad tersa y jugosa, perfecta para platillos de autor.' },
      // Carne Americana
    ...
    pdp: {
      ...
      optVacuum: 'Corte al vacío · por kg', optBulk: 'Caja de mayoreo (5 kg)',
  ...
  en: {
    ...
    products: {
      // Japanese Wagyu A5
      tritip:   { name: 'Tri-Tip Japanese Wagyu A5', badge: 'A5 · Japan', desc: 'Authentic Japanese A5-grade wagyu — the peak of marbling. Buttery, intense, melts on contact.' },
      filete:   { name: 'Filet Japanese Wagyu A5', desc: 'Japanese A5 wagyu filet (tenderloin). The most tender cut — delicate marbling, buttery texture.' },
      ribeyeJp: { name: 'Rib Eye Japanese Wagyu A5', desc: 'Japanese A5 wagyu rib eye — extreme marbling and deep flavor. The wagyu experience at its peak.' },
      picana:   { name: 'Picanha Japanese Wagyu A5', desc: 'Japanese A5 wagyu picanha with its signature fat cap. Juicy and full-flavored, ideal on the grill.' },
      // Australian Wagyu
      ribeye:   { name: 'Australian Wagyu Rib Eye', badge: 'High Marbling', desc: 'Australian wagyu rib eye, intense marbling across the whole eye. The star cut of your menu.' },
      newyork:  { name: 'Australian Wagyu New York', badge: 'Best Seller', desc: 'Firm bite, deep beef flavor and generous marbling. The steakhouse classic.' },
      tbone:    { name: 'Australian Wagyu T-Bone', desc: 'Australian wagyu T-bone — strip and tenderloin in one cut, bone-in for maximum flavor.' },
      paleta:   { name: 'Australian Wagyu Shoulder', desc: 'Australian wagyu shoulder, marbled and versatile. For braising, roasting or thin slicing.' },
      denver:   { name: 'Australian Wagyu Denver', desc: 'Australian wagyu Denver — a juicy, high-marbling cut, tender and full-flavored. Excellent on the grill.' },
      topround: { name: 'Australian Wagyu Top Round', desc: 'Australian wagyu Top Round — rare marbling for this cut. Ideal thinly sliced or in sukiyaki.' },
      lengua:   { name: 'Australian Wagyu Tongue', desc: 'High-marbling Australian wagyu tongue. A tender, juicy specialty, perfect for signature dishes.' },
      // American Beef
    ...
    pdp: {
      ...
      optVacuum: 'Vacuum-packed cut · per kg', optBulk: 'Wholesale box (5 kg)',
