...
export const STRINGS = {
  es: {
    ...
    pdp: {
      ...
      tabs: [{ id: 'desc', label: 'Descripción' }, { id: 'origin', label: 'Origen' }, { id: 'cooking', label: 'Cómo Cocinar' }, { id: 'brands', label: 'Marcas' }],
  ...
  en: {
    ...
    pdp: {
      ...
      tabs: [{ id: 'desc', label: 'Description' }, { id: 'origin', label: 'Origin' }, { id: 'cooking', label: 'How to Cook' }, { id: 'brands', label: 'Brands' }],
