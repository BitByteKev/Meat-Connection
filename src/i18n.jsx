...
export const STRINGS = {
  es: {
    ...
    categories: { all: 'Todos', jp: 'Wagyu Japonés', au: 'Wagyu Australiano' },
    products: {
      ...
      topround: { name: 'Top Round Wagyu Japonés',  badge: 'Más Vendido',    desc: 'Top Round de wagyu japonés — marmoleo poco común en este corte. Ideal en finas láminas, a la parrilla o sukiyaki.' },
      ...
      paleta:   { name: 'Paleta Wagyu Australiano',  badge: 'Versátil',      desc: 'Paleta de wagyu australiano, marmoleada y versátil. Para estofar, asar o cortar en finas láminas.' },
    },
    card: { add: 'Agregar', perKg: 'MXN / kg' },
    pdp: {
      ...
      addToOrder: 'Agregar {qty} kg al pedido · {total}',
    ...
    cart: {
      title: 'Tu Pedido', empty: 'Tu carrito está vacío.', reorderPrev: 'Reordenar pedido anterior',
      ...
      requestWhatsApp: 'Solicitar por WhatsApp', close: 'Cerrar', perKg: 'MXN / kg',
    },
    services: {
    ...
    shop: { title: 'El Catálogo', count: '{n} cortes · porcionados a tu medida' },
    footer: {
  ...
  en: {
    ...
    categories: { all: 'All', jp: 'Japanese Wagyu', au: 'Australian Wagyu' },
    products: {
      ...
      topround: { name: 'Top Round Japanese Wagyu',  badge: 'Best Seller',    desc: 'Japanese wagyu Top Round — rare marbling for this cut. Ideal thinly sliced, grilled or in sukiyaki.' },
      ...
      paleta:   { name: 'Australian Wagyu Shoulder', badge: 'Versatile',      desc: 'Australian wagyu shoulder, marbled and versatile. For braising, roasting or thin slicing.' },
    },
    card: { add: 'Add', perKg: 'MXN / kg' },
    pdp: {
      ...
      addToOrder: 'Add {qty} kg to order · {total}',
    ...
    cart: {
      title: 'Your Order', empty: 'Your cart is empty.', reorderPrev: 'Reorder previous order',
      ...
      requestWhatsApp: 'Request on WhatsApp', close: 'Close', perKg: 'MXN / kg',
    },
    services: {
    ...
    shop: { title: 'The Catalog', count: '{n} cuts · portioned to your spec' },
    footer: {
