...
export const STRINGS = {
  es: {
    ...
    review: {
      decrease: 'Reducir cantidad', increase: 'Aumentar cantidad', remove: 'Quitar corte',
      askPrice: 'Consultar precio', addQuote: 'Agregar a cotización',
      wholesaleRule: 'Mayoreo desde 25 kg combinados entre todos los cortes de tu cotización.',
      oneCut: '1 corte · mayoreo y menudeo', remainingOne: 'Te falta 1 kg para precio de mayoreo', remaining: 'Te faltan {kg} kg para precio de mayoreo', unlocked: 'Precio de mayoreo activado',
      wholesaleProgress: 'Avance hacia 25 kg de mayoreo', preview: 'Incluye la cantidad seleccionada.',
      brand: 'Marca', allBrands: 'Todas las marcas', marbling: 'Marmoleo', allGrades: 'Todos los grados', clearFilters: 'Limpiar filtros',
      stepsEyebrow: 'DE NUESTRO CATÁLOGO A TU COCINA', stepsTitle: 'Tu próximo pedido, en tres pasos',
      stepsSub: 'Arma tu selección y confirma los detalles con nuestro equipo por WhatsApp.',
      steps: [['Elige tus cortes', 'Selecciona marca, grado y kilos. Combina cortes para alcanzar 25 kg y acceder a precios de mayoreo.'], ['Confirma tu cotización', 'Envía tu selección por WhatsApp. Confirma disponibilidad, precio final y cualquier servicio de porcionado o empaque.'], ['Coordina tu entrega', 'Comparte tu destino con el equipo para confirmar el costo de envío y la fecha de entrega antes de cerrar tu pedido.']],
    },
    card: { readMore: 'Ver corte' },
    notice: {
    ...
    pdp: {
      ...
      perKg: '/kg', priceEyebrow: 'Precio de mayoreo', priceEyebrowMenudeo: 'Precio de menudeo', priceFrom: 'Desde',
      priceNote: 'MXN por kg · sujeto a cambio según disponibilidad',
      addToOrder: 'Agregar {qty} kg a la cotización', totalLabel: 'Total ({qty} kg)',
    ...
    cart: {
      ...
      requestWhatsApp: 'Solicitar cotización por WhatsApp', close: 'Cerrar', totalLabel: 'Total estimado',
    },
    services: {
    ...
    contact: {
      ...
      thanksTitle: 'Completa tu solicitud en WhatsApp', thanksMsg: 'Tu mensaje está preparado. Pulsa Enviar en WhatsApp para que recibamos tu solicitud. Si no se abrió, vuelve a intentarlo aquí.', thanksBtn: 'Abrir WhatsApp',
    },
    testimonials: {
  ...
  en: {
    ...
    review: {
      decrease: 'Decrease quantity', increase: 'Increase quantity', remove: 'Remove cut',
      askPrice: 'Ask for pricing', addQuote: 'Add to quote',
      wholesaleRule: 'Wholesale pricing starts at 25 kg combined across all cuts in your quote.',
      oneCut: '1 cut · wholesale & retail', remainingOne: 'Add 1 kg to unlock wholesale pricing', remaining: 'Add {kg} kg to unlock wholesale pricing', unlocked: 'Wholesale pricing unlocked',
      wholesaleProgress: 'Progress toward 25 kg wholesale', preview: 'Includes the selected quantity.',
      brand: 'Brand', allBrands: 'All brands', marbling: 'Marbling', allGrades: 'All grades', clearFilters: 'Clear filters',
      stepsEyebrow: 'FROM OUR CATALOG TO YOUR KITCHEN', stepsTitle: 'Your next order, in three steps',
      stepsSub: 'Build your selection and confirm the details with our team on WhatsApp.',
      steps: [['Choose your cuts', 'Select your brand, grade and kilograms. Combine cuts to reach 25 kg and access wholesale pricing.'], ['Confirm your quote', 'Send your selection through WhatsApp. Confirm availability, final pricing and any portioning or packaging services.'], ['Arrange delivery', 'Share your destination with the team to confirm shipping costs and the delivery date before finalizing your order.']],
    },
    card: { readMore: 'View cut' },
    notice: {
    ...
    pdp: {
      ...
      perKg: '/kg', priceEyebrow: 'Wholesale price', priceEyebrowMenudeo: 'Retail price', priceFrom: 'From',
      priceNote: 'MXN per kg · subject to change based on availability',
      addToOrder: 'Add {qty} kg to quote', totalLabel: 'Total ({qty} kg)',
    ...
    cart: {
      ...
      requestWhatsApp: 'Request a quote on WhatsApp', close: 'Close', totalLabel: 'Estimated total',
    },
    services: {
    ...
    contact: {
      ...
      thanksTitle: 'Finish your request in WhatsApp', thanksMsg: 'Your message is ready. Tap Send in WhatsApp so we receive your request. If WhatsApp did not open, try again below.', thanksBtn: 'Open WhatsApp',
    },
    testimonials: {
